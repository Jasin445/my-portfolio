...
const ProjectModal = ({ project, isOpen, onClose, onNavigate, hasNext, hasPrev }) => {
            ...
            <div className="flex-1 p-6 overflow-y-auto">
              {activeTab === 'overview' && (
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {project?.technologies?.map((tech, index) => (
                        ...
                        >
                          <Icon name={getTechIcon(tech)} size={16} className="text-primary" />
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-foreground mb-2">Completed</h4>
              ...
              {activeTab === 'technical' && (
                <div className="space-y-6">
                  ...
                  {project?.codeSnippet && (
                    <div>
                      <h3 className="text-lg font-semibold text-foreground mb-3">Code Example</h3>
                  ...
                  {project?.challenges?.map((challenge, index) => (
                    <div key={index} className="border border-border rounded-lg p-4">
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <h5 className="text-sm font-medium text-foreground mb-1">Solution</h5>
                          <p className="text-muted-foreground leading-relaxed">
                            {challenge?.solution}
                          </p>
                        </div>
