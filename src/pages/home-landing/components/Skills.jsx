...
const Skills = () => {
  return (
    <section className="py-2 px-4 sm: bg-gradient-to-b from-[#2a363c]/90 to-[#131426]/95">
      <div
        className="bg-gradient-to-b from-[#2a363c]/80 to-transparent hover:shadow-[0_0_12px_rgba(1,149,255,0.25)] backdrop-blur-sm border-white max-w-5xl border py-8 sm:py-12 px-2 sm:px-8 rounded-2xl shadow-xl
 mx-auto text-center"
      >
        <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-2 sm:mb-6">
          Technical Skills
        </h2>
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-14 sm:mb-8">
        ...
        <div className="flex flex-wrap justify-center gap-12">
          ...
          <div className="sm:flex hidden flex-col items-center justify-center gap-6">
            <SiCss3
              size={44}
