...
const Skills = () => {
  return (
    <section className="py-2 px-6 bg-gradient-to-b from-[#2a363c]/90 to-[#131426]/95">
      <div
        className="bg-gradient-to-b from-[#2a363c]/80 to-transparent hover:shadow-[0_0_12px_rgba(1,149,255,0.25)] backdrop-blur-sm border-white max-w-5xl border py-12 px-8 rounded-2xl shadow-xl
 mx-auto text-center"
      >
