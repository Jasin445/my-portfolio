...
const FeaturedProjects = () => {
  const featuredProjects = [
    ...
    },
    {
      ...
      description: "An interactive weather widget with location-based forecasts, animated weather icons, and detailed meteorological data.",
    ...
    },
    {
      ...
      description: "A responsive portfolio website showcasing creative work with smooth animations, optimized performance, and SEO best practices.",
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          {featuredProjects?.map((project, index) => (
            <div
              key={project?.id}
              className="group bg-card rounded-xl border border-border overflow-hidden hover:shadow-lg transition-all duration-slow hover:-translate-y-1"
            >
              {/* Project Image */}
